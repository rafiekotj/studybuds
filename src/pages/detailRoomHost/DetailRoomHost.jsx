  ...
  return (
    <>
      <div className={detailRoomHostStyle.detailRoom}>
        ...
        <div className={detailRoomHostStyle.detailTitle}>
          <div className={detailRoomHostStyle.titleHead}>
            <p className={detailRoomHostStyle.titleName}>
              Advanced Biology by Dr. Kusanagi
            </p>
            <div className={detailRoomHostStyle.titleStory}>
              <div className={detailRoomHostStyle.titleDate}>
                <RiCalendar2Fill className={detailRoomHostStyle.icon} />
                <p className={detailRoomHostStyle.info}>
                  4 October 2021 | 12:00 - 13:00
                </p>
              </div>
              <div className={detailRoomHostStyle.titleNumber}>
                <BsPeopleFill className={detailRoomHostStyle.icon} />
                <p className={detailRoomHostStyle.info}>
                  0/50 <span>(1.000 people interested to join)</span>
                </p>
                <Button classStyle="buttonGreen">
                  <Link
                    to="/approve"
                    className={detailRoomHostStyle.approveBtn}
                  >
                    Approve Participant
                  </Link>
                </Button>
          ...
          <div className={detailRoomHostStyle.edDeBtn}>
        ...
        <div className={detailRoomHostStyle.detailContainer}>
          <div className={detailRoomHostStyle.containerTitle}>
            <Link className={detailRoomHostStyle.containerAbout} to="">
              About Class
            </Link>
          </div>
          <div className={detailRoomHostStyle.containerMaterial}>
            <div className={detailRoomHostStyle.materialDescription}>
              <div className={detailRoomHostStyle.descriptionTitle}>
                Description
              </div>
              <img
                ...
                alt="Math"
              />
              <div className={detailRoomHostStyle.descriptionNarration}>
                <p>
            ...
            <div className={detailRoomHostStyle.hostSection}>
              <div className={detailRoomHostStyle.materialHost}>
                <div className={detailRoomHostStyle.hostTitle}>Host</div>
                <div className={detailRoomHostStyle.hostProfile}>
                  <Avatar
                    className={detailRoomHostStyle.hostAvatar}
                  ...
                  />
                  <div className={detailRoomHostStyle.hostName}>
                    J. Walker Denny Walter
                  </div>
                </div>
                <div className={detailRoomHostStyle.hostClassStatus1}>
                  Class Status
                </div>
                <div className={detailRoomHostStyle.hostClassStatus2}>
                  Restricted
                </div>
              </div>
              <div className={detailRoomHostStyle.startBtn}>
